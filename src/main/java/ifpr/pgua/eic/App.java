...
public class App extends BaseAppNavigator {
    ...
    public void registrarTelas() {
        ...
        registraTela("LOGIN", new ScreenRegistryFXML(getClass(), "fxml/auth/Login.fxml",
                (o) -> new LoginController()));

        registraTela("ALTERAR_SENHA", new ScreenRegistryFXML(getClass(), "fxml/auth/AlterarSenha.fxml",
                (o) -> new AlterarSenhaController()));

        registraTela("CADASTRO_USUARIO", new ScreenRegistryFXML(getClass(), "fxml/users/CadastroUsuario.fxml",
